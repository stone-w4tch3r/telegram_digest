...
namespace TelegramDigest.Backend.Migrations
{
    ...
    [Migration("20250629103920_RemoveDefaultGuidUserIdFromFkInContext")]
    partial class RemoveDefaultGuidUserIdFromFkInContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramDigest.Backend.Db.DigestEntity", b =>
                {
                    b.HasOne("TelegramDigest.Backend.Infrastructure.Identity.ApplicationUser", "UserNav")
                        .WithMany()
                        .HasForeignKey("UserId")
